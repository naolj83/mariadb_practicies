...
-- 출력은 이름, 성별, 입사일 순서이고 “이름”, “성별”, “입사일로 컬럼 이름을 대체해보세요.
...
-- 문제7.
-- 전체 부서를 출력하려고 합니다. 순서는 부서이름이 긴 순서대로 출력해 보세요.length(emp_name) desc
select dept_name
from departments
...
-- 문제10
-- 현재 Engineer 직책의 사원은 총 몇 명입니까? where절 2개 - 현재, Engineer
select count(*)
from titles
